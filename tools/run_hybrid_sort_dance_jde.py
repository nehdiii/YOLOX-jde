...
from yolox.evaluators import MOTEvaluatorJDE as MOTEvaluator
...
def main(exp, args, num_gpu):
    ...
    # Dedicated JDE runner: force HybridSORT-ReID to use embeddings produced by
    # the YOLOX-JDE head, not the external FastReID crop encoder.
