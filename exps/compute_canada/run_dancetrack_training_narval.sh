#!/bin/bash
# Shared launcher for Narval. Call from inside a Slurm allocation/job.
...
ACTIVATE_SCRIPT="${ACTIVATE_SCRIPT:-$REPO_DIR/exps/compute_canada/activate_track_narval.sh}"
...
echo "================================================================================"
echo "Narval YOLOX-JDE training launcher"
echo "Host          : $(hostname)"
...
# Narval A100 multi-node stability defaults.
