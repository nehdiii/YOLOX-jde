...
class Exp(MyExp):
    def __init__(self):
        ...
        self.depth = 1.33
        self.width = 1.25
        self.exp_name = os.environ.get("EXP_NAME", "yolox_x_dancetrack_jde_v2_stage1_no_lb_rw025_dim128_param")
        ...
        # Stage 1 ablation: main V2 effect.
        # Fixed best JDE branch settings from V1:
        #   reid_dim = 128
        #   reid_weight = 0.75
        #   use_uncertainty = True
        # Swept V2 matching strength:
        #   reid_match_weight = 0.0
        # Fixed V2 settings:
        #   reid_match_max_cost = 2.0
        #   use_reid_in_dynamic_k = True

        # Compact Stage 1 V2 ablation, no loss balancing:
        # fixed: reid_dim=128, reid_weight=0.25, use_uncertainty=False
        # fixed: reid_match_max_cost=2.0, use_reid_in_dynamic_k=True
        # swept by env var REID_MATCH_WEIGHT: 0.00, 0.05, 0.10, 0.20, 0.30

        # V2 contribution: identity-aware SimOTA matching.
        self.reid_match_weight = float(os.environ.get("REID_MATCH_WEIGHT", "0.0"))
