# encoding: utf-8
"""DanceTrack JDE V1 ablation: v1_rw075_dim128.

Generated from exps/example/mot/yolox_dancetrack_val_jde_v1.py in the latest repo.
This is JDE V1: normal YOLOX/SimOTA assignment; ReID loss only after positive anchors.
...
class Exp(MyExp):
    def __init__(self):
        ...
        print("[JDE V1 ABLATION SETTINGS] name=v1_rw075_dim128, reid_weight=0.75, reid_dim=128, max_epoch=8")
