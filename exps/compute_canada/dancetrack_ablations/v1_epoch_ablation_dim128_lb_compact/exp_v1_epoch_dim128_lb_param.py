...
class Exp(MyExp):
    def __init__(self):
        ...
        self.depth = 1.33
        self.width = 1.25
        self.exp_name = os.environ.get("EXP_NAME", "yolox_x_dancetrack_jde_v1_epoch_dim128_lb_param")
        ...
        self.max_epoch = int(os.environ.get("MAX_EPOCH", "12"))
        ...
        # JDE branch settings.
        self.reid_dim = 128
        self.reid_weight = 0.75
        self.use_uncertainty = True
        self.label_id_index = 5

        # Compact V1 epoch ablation:
        # fixed: JDE V1, reid_dim=128, use_uncertainty=True, no_aug_epochs=1
        # reid_weight is kept at 0.75 for bookkeeping; with use_uncertainty=True
        # the learned s_id parameter controls the effective ID-loss weight.
        # swept by env var MAX_EPOCH: 12, 16, 20, 25, 30
