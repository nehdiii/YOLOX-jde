...
class Exp(MyExp):
    def __init__(self):
        ...
        self.depth = 1.33
        self.width = 1.25
        self.exp_name = "yolox_x_dancetrack_jde_v1_lb_rw075_dim128"
        ...
        # V1 loss-balancing reid_weight ablation:
        # fixed reid_dim = 128
        # use_uncertainty = True activates learnable s_det and s_id.
        # reid_weight is still swept to test how much ID supervision is injected
        # before learned uncertainty balancing.
