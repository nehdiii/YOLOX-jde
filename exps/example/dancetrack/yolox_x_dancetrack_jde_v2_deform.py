# encoding: utf-8
"""YOLOX-X DanceTrack JDE V2 + Deform tracking config.

This config is for local tracking/evaluation after training the V2+Deform JDE model.
It uses the same DanceTrack/HybridSORT-JDE tracking settings as V1, but loads
the V2+Deform head where ReID is used inside SimOTA and the ReID map is box-aware/deformed.
"""
...
class Exp(MyExp):
    def __init__(self):
        ...
        # V2 + Deform contribution: box-aware deformable ReID descriptor.
