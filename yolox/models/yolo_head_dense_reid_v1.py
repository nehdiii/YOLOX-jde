#!/usr/bin/env python3
# -*- coding:utf-8 -*-
# Clean YOLOX-JDE V1 dense ReID head.
# Based on the local YOLOX head, with detection SimOTA kept unchanged.
...
class YOLOXHead(nn.Module):
    def __init__(
        ...
        # JDE V1: detection path stays identical. ReID is trained after SimOTA
        # assignment, using only the positive anchors selected by the detector.
